...
class APIService: APIServiceProtocol {
    ...
    static let basicHeaders: HTTPHeaders = [
        "accept-language": "en",
        "cache-control": "no-cache",
        "x-api-key": "0dde82cb-9a5b-4161-a264-32b6ea234f33"
    ]
        
    static func get<T: Decodable>(_ url: String, _ parameters: [String:Any]? = nil,  completion: @escaping (Result<T, Error>) -> Void) {
...
//            debugResponse(response: response)
    ...
    private static func handleResponse<T: Decodable>(response: DataResponse<T, AFError>, completion: (Result<T, Error>) -> Void) {
